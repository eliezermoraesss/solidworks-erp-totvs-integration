...
class ConsultaApp(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.dark_theme_enabled = False  # Mantenha o controle do estado do tema
        ...
        self.btn_alternar_tema = QPushButton("Alternar Tema", self)
        ...
        layout_linha_03.addWidget(self.btn_alternar_tema)
    ...
    def alternar_tema(self):
        # Toggle do estado do tema
        self.dark_theme_enabled = not self.dark_theme_enabled
        # Carregue a folha de estilo correspondente ao tema atual
