...
End Sub
Sub MensagemBOM()
    MsgBox "SELECIONE A TABELA DE BOM" & vbNewLine & vbNewLine & "Por gentileza, clique em qualquer parte da tabela de BOM e tente novamente!", vbInformation, "CADASTRO DE ESTRUTURA - TOTVS"
End Sub
Sub MensagemSalvarDesenho()
    MsgBox "SALVE O DESENHO!" & vbNewLine & vbNewLine & "Para continuar com o cadastro da BOM, por favor, salve este detalhamento!", vbInformation, "CADASTRO DE ESTRUTURA - TOTVS"
End Sub
