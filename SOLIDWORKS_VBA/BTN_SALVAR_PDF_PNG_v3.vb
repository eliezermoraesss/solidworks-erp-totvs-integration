...
Private Sub SaveAsPDF()
    ...
    If Dir(pdfPath) <> "" Then
        MsgBox "PDF salvo com sucesso!", vbInformation, "Sucesso"
    Else
...
Private Sub SaveNewPNGFile(tifPath As String)
    ...
    If Dir(pngPath) <> "" Then
        MsgBox "PNG salvo com sucesso!", vbInformation, "Sucesso"
    Else
...
Private Sub ShowConfirmationDialog()
    Dim message As String
    message = "Já existe uma revisão deste desenho." & vbNewLine & vbNewLine & _
