...
SELECT * FROM PROTHEUS1233_HML.dbo.SBM010 WHERE BM_GRUPO = '2808';
...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-052-060-638';
...
SELECT B1_COD, B1_DESC, B1_XDESC2, B1_TIPO, B1_UM, B1_LOCPAD, B1_GRUPO, B1_ZZNOGRP, B1_CC, B1_MSBLQL, B1_REVATU FROM PROTHEUS12_R27.dbo.SB1010 s WHERE B1_DESC LIKE 'FORMADOR DE FILA%';
...
SELECT * FROM PROTHEUS1233_HML.dbo.SB1010 WHERE B1_COD = 'E7047-001-938';
