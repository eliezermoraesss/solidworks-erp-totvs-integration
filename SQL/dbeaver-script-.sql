...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'E3919-004-013' AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*';
...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-048-008-766'
AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*'
AND G1_REVFIM = (SELECT MAX(G1_REVFIM) FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-048-008-766'AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*');
...
UPDATE PROTHEUS12_R27.dbo.SB1010 SET B1_MSBLQL = '2' WHERE B1_COD  = 'C-003-090-072' AND D_E_L_E_T_ <> '*';
...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COMP = 'E7047-001-936' 
...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-033-013-534'
AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*'
AND G1_REVFIM = (SELECT MAX(G1_REVFIM) FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-033-013-534' AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*');


UPDATE PROTHEUS12_R27.dbo.SB1010 SET B1_REVATU = '002' WHERE B1_COD = 'M-022-038-187';
